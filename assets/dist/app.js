...
exports.drawPercentageText = exports.arcTween = exports.drawChartArcs = exports.drawDonut = exports.dispatch = undefined;
...
var halfSize = size / 2;
var fontSize = '1.75vw';
var modifier = winWidth < 768 ? 4 : 16;
var innerRadius = halfSize - modifier;
...
var drawChartArcs = exports.drawChartArcs = function drawChartArcs(svg, data) {
	var pie = d3.pie().value(data.value);
...
var drawPercentageText = exports.drawPercentageText = function drawPercentageText(svg, data) {
	svg.append('text').data([data]).attr('font-family', 'Anton').attr('font-size', '0rem').attr('fill', data.color).attr('text-anchor', 'middle').attr('y', '1rem').html(function () {
		var text = data.text;
		var value = data.showPercent ? data.value + '%' : '';
...
var drawSkills = exports.drawSkills = function drawSkills(words) {
	d3.select('#skills-cloud').selectAll('text').data(shuffle(words)).enter().append('span').attr('class', function (d) {
