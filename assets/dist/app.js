...
var _skills = __webpack_require__(469);

var _canvas = __webpack_require__(173);

var _skillsList = __webpack_require__(470);

var _heroTexts = __webpack_require__(471);

var _animateTopOffset = __webpack_require__(472);
...
exports.createNodes = exports.createLinks = exports.createSimulation = exports.dragHandler = exports.drawSkills = undefined;
	...
	var renderSkills = function renderSkills(data) {
		...
		simulation.nodes(data.nodes).on('tick', function () {
			...
			nodes.each(function (d, i) {
				...
				var text = d3.select(group.querySelector('text'));
				var image = d3.select(group.querySelector('image'));
...
var createSimulation = exports.createSimulation = function createSimulation(width, height) {
	return d3.forceSimulation().force('link', d3.forceLink().id(function (d) {
		return d.index;
	})).force('collide', d3.forceCollide(function (d) {
		return d.r * 1.75;
	}).iterations(20)).force('charge', d3.forceManyBody()).force('center', d3.forceCenter(width / 2, height / 2)).force('y', d3.forceY(0)).force('x', d3.forceX(0));
};
...
var createNodes = exports.createNodes = function createNodes(svg, data, winWidth, callable) {
