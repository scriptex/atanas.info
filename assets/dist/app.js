...
var _canvas = __webpack_require__(174);
...
var drawPercentageText = exports.drawPercentageText = function drawPercentageText(svg, data) {
	svg.append('text').data([data]).attr('font-family', 'Anton').attr('font-size', '0rem').attr('fill', data.color).attr('text-anchor', 'middle').attr('y', '1rem').html(function () {
		var hasPercent = data.showPercent;
		var textDY = hasPercent ? -20 : 5;
		var text = getTspan(data.text, textDY);
		var value = data.showPercent ? getTspan(data.value + '%', 50) : '';

		return text + value;
	}).transition().attr('font-size', fontSize).duration(transitionsDuration).delay(transitionsDelay).ease(transitionType);
};
...
var _skills = __webpack_require__(470);

var _canvas = __webpack_require__(174);

var _donut = __webpack_require__(173);

var _skillsList = __webpack_require__(471);
...
var drawSkills = exports.drawSkills = function drawSkills(words) {
	d3.select('#skills-cloud').selectAll('text').data(words).enter().append('span').attr('class', function (d) {
		return 'c-skill--' + d.size;
...
var skills = exports.skills = [{ text: 'JavaScript', size: 1, value: 100 }, { text: 'React', size: 2, value: 75 }, { text: 'AngularJS', size: 3, value: 90 }, { text: 'Vue', size: 2, value: 90 }, { text: 'Backbone', size: 4, value: 65 }, { text: 'D3', size: 2, value: 95 }, { text: 'jQuery', size: 4, value: 100 }, { text: 'nodejs', size: 3, value: 85 }, { text: 'Gulp', size: 3, value: 100 }, { text: 'Grunt', size: 4, value: 95 }, { text: 'Webpack', size: 2, value: 90 }, { text: 'CSS / CSS3', size: 1, value: 100 }, { text: 'LESS', size: 2, value: 100 }, { text: 'SASS', size: 1, value: 100 }, { text: 'PostCSS', size: 1, value: 100 }, { text: 'HTML / HTML5', size: 2, value: 100 }, { text: 'SVG', size: 2, value: 95 }, { text: 'Ionic', size: 3, value: 90 }, { text: 'Bootstrap', size: 3, value: 100 }, { text: 'Foundation', size: 4, value: 95 }, { text: 'SVN', size: 5, value: 80 }, { text: 'GIT', size: 3, value: 95 }, { text: 'PHP', size: 3, value: 85 }, { text: 'WordPress', size: 2, value: 85 }, { text: 'Squarespace', size: 4, value: 80 }, { text: 'Shopify', size: 5, value: 75 }, { text: 'Photoshop', size: 4, value: 95 }, { text: 'Illustrator', size: 4, value: 70 }, { text: 'Sketch', size: 4, value: 85 }, { text: 'Affinity Designer', size: 3, value: 90 }, { text: 'Bash', size: 3, value: 70 }, { text: 'Meteor', size: 3, value: 70 }];
