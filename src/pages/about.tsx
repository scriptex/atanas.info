...
import { Layout, Section, Animation, ExternalLink } from '@components';
	...
	<Layout>
		...
		>
			...
			<div className="c-article__block">
				...
				<p>
					My <ExternalLink href="https://scriptex.tk/">interactive resume</ExternalLink>, which is built using
					the <ExternalLink href="https://docs.codersrank.io/widgets/">CodersRank widgets</ExternalLink>, is
					featured in the{' '}
				...
				<p>
					My{' '}
					<ExternalLink href="https://profile.codersrank.io/user/scriptex/">CodersRank profile</ExternalLink>{' '}
					is featured in the{' '}
