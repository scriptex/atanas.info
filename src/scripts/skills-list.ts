...
export const skills: Skill[] = [
	...
	{ text: 'Github Actions', icon: 'github', width: 30, height: 30, fill: '#fff', since: 2020 },
	{ text: 'Gitlab CI/CD', icon: 'gitlab', width: 30, height: 30, fill: '#fff', since: 2017 },
	...
	{ text: 'Markdown', icon: 'markdown', width: 30, height: 30, fill: '#fff', since: 2014 },
	{ text: 'Microsoft Azure', icon: 'azure', width: 30, height: 30, fill: '#353134', since: 2019 },
	{ text: 'MJML', icon: 'mjml', width: 30, height: 30, fill: '#3fa', since: 2019 },
