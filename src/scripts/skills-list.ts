...
export const skills: Skill[] = [
	...
	{ text: 'Babel', icon: 'babel', width: 31, height: 12, fill: '#222', since: 2015 },
	...
	{ text: 'BEM', icon: 'bem', width: 29, height: 24, fill: '#000', since: 2013 },
	...
	{ text: 'Gitlab CI/CD', icon: 'gitlab-logo', width: 30, height: 30, fill: '#fff', since: 2017 },
	...
	{ text: 'Highcharts', icon: 'highcharts', width: 30, height: 29, fill: '#3a3a4f', since: 2016 },
	...
	{ text: 'Markdown', icon: 'markdown', width: 32, height: 20, fill: '#fff', since: 2014 },
	{ text: 'MJML', icon: 'mjml', width: 30, height: 26, fill: '#3fa', since: 2019 },
	{ text: 'Microsoft Azure', icon: 'azure', width: 30, height: 24, fill: '#353134', since: 2019 },
	...
	{ text: 'Redux Saga', icon: 'redux-saga', width: 30, height: 19, fill: '#9c3b2d', since: 2018 },
	...
	{ text: 'Vercel', icon: 'vercel', width: 30, height: 26, fill: '#000', since: 2019 },
	{ text: 'Visual Studio Code', icon: 'vscode', width: 30, height: 30, fill: '#fff', since: 2017 },
	{ text: 'Vue', icon: 'vue', width: 30, height: 26, fill: '#4a5c71', since: 2016 },
