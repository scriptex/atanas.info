...
import projectsList from '~/src/data/projects-list.json';
import { Button, Loader, Section, ExternalLink } from '~/src/components';
import { Project, projects, MobileApp, mobileApps } from '~/src/data/projects';
