...
import npmStats from '~/src/data/npm-stats.json';
import { isPrerendering } from '~/src/scripts/shared';
import gitlabCalendarData from '~/src/data/gitlab-calendar.json';
import GitlabActivityCalendar from '~/src/scripts/gitlab-calendar';
import { Section, GithubSkyline, ExternalLink } from '~/src/components';
