...
import github from '~/src/data/github-insights.json';
import gitlab from '~/src/data/gitlab-insights.json';
import { Routes } from '~/src/data/routes';
import { Svg, Nav, Head, Header, Footer, Loader, Contact, ScrollToTop } from '~/src/components';
import {
	Home,
	Blog,
	About,
